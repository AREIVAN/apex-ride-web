...
**Apex Ride** es un prototipo funcional de una plataforma de telemetría y competencia para **motos y coches**, inspirada en el concepto de *segmentos* y *leaderboards* tipo Strava, pero enfocada en conducción motorizada.
...
- Estilo visual *cyberpunk / gaming HUD*
