  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-7xl flex-col px-5 pb-16 pt-36 sm:px-8 lg:px-10 lg:pb-20">
        <p className="text-xs font-semibold uppercase tracking-[0.24em] text-brand-100">Performance Mobility Platform</p>
        ...
        <p className="mt-6 max-w-xl text-base leading-relaxed text-slate-200 sm:text-lg">
          Apex Ride transforma salidas en progreso real: tracking preciso, mapas accionables y competencia comunitaria
          para riders que entrenan con ambicion.
        </p>
